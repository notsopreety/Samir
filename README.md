...
pip install lolcat
git clone https://github.com/notsopreety/Samir
cd Samir
chmod +x *
sh install.sh
exit
...
```
apt update && upgrade -y && apt install git -y && pkg install mpv figlet python && pip install lolcat && git clone https://github.com/notsopreety/Samir && cd Samir && chmod +x * && ./install.sh
```
## screen shot
